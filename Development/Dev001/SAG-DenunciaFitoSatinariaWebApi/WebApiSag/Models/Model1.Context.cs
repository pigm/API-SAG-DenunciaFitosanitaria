...
namespace WebApiSag.Models
{
    ...
    public partial class dbDenunciaFitoSanitariaEntities : DbContext
    {
        ...
        public virtual DbSet<CategoriaTipoDenuncia> CategoriaTipoDenuncia { get; set; }
        ...
        public virtual int usp_VendedorSilenciosoOperacion(Nullable<int> start, Nullable<int> length, Nullable<int> storeNbr, Nullable<int> orderColumn, Nullable<int> columnOrder, Nullable<int> filter_status, Nullable<int> filter_item_nbr, Nullable<decimal> filter_upc_nbr, string filter_marca, string filter_descripcion, string filter_departamento, Nullable<int> filter_categoria)
        {
            ...
            var storeNbrParameter = storeNbr.HasValue ?
                new ObjectParameter("StoreNbr", storeNbr) :
                new ObjectParameter("StoreNbr", typeof(int));
            ...
            var columnOrderParameter = columnOrder.HasValue ?
                new ObjectParameter("ColumnOrder", columnOrder) :
                new ObjectParameter("ColumnOrder", typeof(int));
    
            var filter_statusParameter = filter_status.HasValue ?
                new ObjectParameter("filter_status", filter_status) :
                new ObjectParameter("filter_status", typeof(int));
    
            var filter_item_nbrParameter = filter_item_nbr.HasValue ?
                new ObjectParameter("filter_item_nbr", filter_item_nbr) :
                new ObjectParameter("filter_item_nbr", typeof(int));
    
            var filter_upc_nbrParameter = filter_upc_nbr.HasValue ?
                new ObjectParameter("filter_upc_nbr", filter_upc_nbr) :
                new ObjectParameter("filter_upc_nbr", typeof(decimal));
    
            var filter_marcaParameter = filter_marca != null ?
                new ObjectParameter("filter_marca", filter_marca) :
                new ObjectParameter("filter_marca", typeof(string));
    
            var filter_descripcionParameter = filter_descripcion != null ?
                new ObjectParameter("filter_descripcion", filter_descripcion) :
                new ObjectParameter("filter_descripcion", typeof(string));
    
            var filter_departamentoParameter = filter_departamento != null ?
                new ObjectParameter("filter_departamento", filter_departamento) :
                new ObjectParameter("filter_departamento", typeof(string));
    
            var filter_categoriaParameter = filter_categoria.HasValue ?
                new ObjectParameter("filter_categoria", filter_categoria) :
                new ObjectParameter("filter_categoria", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_VendedorSilenciosoOperacion", startParameter, lengthParameter, storeNbrParameter, orderColumnParameter, columnOrderParameter, filter_statusParameter, filter_item_nbrParameter, filter_upc_nbrParameter, filter_marcaParameter, filter_descripcionParameter, filter_departamentoParameter, filter_categoriaParameter);
        }
    
        public virtual ObjectResult<sp_ListadoDenuncias_Result> sp_ListadoDenuncias(string estadoDenuncia, string tipoDenuncia, string fecha, string categoria, string subCategoria, string region, string comuna)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_ListadoDenuncias_Result>("sp_ListadoDenuncias", estadoDenunciaParameter, tipoDenunciaParameter, fechaParameter, categoriaParameter, subCategoriaParameter, regionParameter, comunaParameter);
        }
    }
}
